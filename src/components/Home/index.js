        ...
        <div className="r-content-container">
          ...
          <div className="content-box1">
            ...
            <div className="box-2">
              ...
              <p className="backup-desc">
                HostingHero gives you the ability to enjoy the benefits of HTTP
                / 2. You can use resources to load in parallel, and even load
                them BEFORE the browser asks for them.
              </p>
            </div>
          </div>
        </div>
